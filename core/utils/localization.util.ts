...
export function createLocalizer(localization: AppConfigResponse.Localization) {
...
export function createLocalizerWithFallback(localization: AppConfigResponse.Localization) {
...
export function createLocalizationPipeKeyGenerator(
  localization: AppConfigResponse.Localization,
) {
  const findLocalization = createLocalizationFinder(localization);
...
function createLocalizationFinder(localization: AppConfigResponse.Localization) {
